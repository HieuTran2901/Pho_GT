        ...
        <div className="w-full xl:w-[185px] 2xl:w-[205px] shrink-0 flex flex-col justify-between p-4 sm:p-5 rounded-2xl bg-gradient-to-b from-[#24170f]/90 via-[#180e09]/90 to-[#0e0704]/90 border border-[#d4af37]/25 shadow-inner">
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-[#8a1e14] to-[#450e09] border border-amber-400/50 flex items-center justify-center text-amber-200 shadow-md shadow-[#8a1e14]/40 shrink-0">
                <Layers className="w-5 h-5 text-amber-300" />
              </div>
              <div>
                <h3 className="font-serif font-bold text-xl text-[#fcedc7] tracking-wide flex items-center gap-1.5">
          ...
          <div className="mt-4 pt-3 border-t border-[#d4af37]/15 flex items-center justify-between text-stone-400">
            <div className="space-y-1">
              ...
              <div className="text-[11px] font-serif text-stone-300">
                {floorNumber === 1 ? 'Nồi phở sôi sục 24/7' : 'View ngắm phố đêm'}
              </div>
            </div>
            <div className="w-9 h-9 rounded-full bg-amber-500/10 border border-amber-500/25 flex items-center justify-center text-amber-400/90 shadow-xs">
